...
from avl import AVLNode, AVLTree, Stack
from avl import rotate_right, rotate_left
from avl import rotate_double_left, rotate_double_right
...
if __name__ == '__main__':
    ...
    test_right_rotation()
    print('OK: Right rotation passed')

    test_left_rotation()
    print('OK: Left rotation passed')

    test_insertion()
    print('OK: Insertion works')

    test_del()
    print('OK: Deletion works')

    test_selfbalancing()
    print('OK: Tree self balances')
